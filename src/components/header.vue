<template>
<nav id="header" class="w-full z-30 top-10 py-1 bg-white shadow-lg border-b border-neutral-400">
      <div class="w-full flex items-center justify-between mt-0 px-6 py-2">
         <label for="menu-toggle" class="cursor-pointer md:hidden block">
            <svg class="fill-current text-neutral-600" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
               <title>menu</title>
         ...
         <div class="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1" id="menu">
            <nav>
               <ul class="md:flex items-center justify-between text-base text-neutral-600 pt-4 md:pt-0">
         ...
         <div class="order-2 md:order-3 flex flex-wrap items-center justify-end mr-0 md:mr-4" id="nav-content">
            <div class="auth flex items-center w-full md:w-full">
               ...
               <button class="bg-neutral-600 text-gray-200  p-2 rounded  hover:bg-neutral-500 hover:text-gray-100">Sign up</button>
            </div>
         </div>
      </div>
   </nav>
